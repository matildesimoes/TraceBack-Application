        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(
                '   At TraceBack, we take your privacy seriously. This Privacy Policy explains how we collect, use, and protect information about you when you use our app. By using our service, you consent to the collection, use, and disclosure of your information as described in this Privacy Policy.\n'
                ...
                'We may update this Privacy Policy from time to time. If we make material changes, we will provide notice by posting a notice on our app or by other means.\n',
                style: TextStyle(
                  fontSize: 16,
                ),
              ),
              ...
              Text(
                'You agree to use TraceBack in compliance with applicable laws and regulations. You are responsible for maintaining the confidentiality of your account information and for any activities that occur under your account. We are not responsible for any unauthorized access to your account or any loss or damage that may result from your failure to comply with this responsibility.\n'
                'You are solely responsible for any content or information that you submit or transmit through our app. You warrant that you have all necessary rights to submit or transmit such content or information and that it does not infringe the intellectual property rights or privacy rights.\n'
